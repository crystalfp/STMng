 ...
 * @since 2024-10-26
 */
import type {BasisType, PositionType, Structure} from "../src/types"; // TBD
import {basisToLengthAngles} from "../src/electron/modules/Helpers";
...
export class Lattice {
	...
	get matrix(): number[] {
		...
		const out: number[] = Array(9).fill(0);
