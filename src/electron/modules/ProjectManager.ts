...
class ProjectManager {
	...
	private readonly allNodes: OneNodeInfo[] = [
		...
		{type: "structure-reader",		in: false, out: true, opt: false,  graphic: "none",
										handler: StructureReader,
										idPrefix: "reader",    ui: "StructureReaderCtrl"},
		{type: "structure-backbone",   	in: true,  out: false, opt: false, graphic: "out",
										handler: StructureBackbone,
									   	idPrefix: "backbone",  ui: "StructureBackboneCtrl"},
		{type: "compute-symmetries",   	in: true,  out: true, opt: false,  graphic: "none",
										handler: ComputeSymmetries,
									   	idPrefix: "symmetry",  ui: "ComputeSymmetriesCtrl"},
		{type: "diffraction-pattern",  	in: true,  out: false, opt: false, graphic: "none",
										handler: DiffractionPattern,
									   	idPrefix: "xray",      ui: "DiffractionPatternCtrl"},
		{type: "draw-structure",       	in: true,  out: false, opt: false, graphic: "out",
										handler: DrawStructure,
									   	idPrefix: "draw",      ui: "DrawStructureCtrl"},
		{type: "draw-unit-cell",       	in: true,  out: true, opt: true,   graphic: "out",
										handler: DrawUnitCell,
									   	idPrefix: "unit",      ui: "DrawUnitCellCtrl"},
		{type: "compute-bonds",        	in: true,  out: true, opt: false,  graphic: "none",
										handler: ComputeBonds,
									   	idPrefix: "bonds",     ui: "ComputeBondsCtrl"},
		{type: "compute-fingerprints", 	in: true,  out: false, opt: false, graphic: "none",
										handler: ComputeFingerprints,
									   	idPrefix: "cfp",       ui: "ComputeFingerprintsCtrl"},
		{type: "isosurface",           	in: true,  out: false, opt: false, graphic: "out",
										handler: DrawIsosurface,
									   	idPrefix: "iso",       ui: "DrawIsosurfaceCtrl"},
		{type: "orthoslice",           	in: true,  out: false, opt: false, graphic: "out",
										handler: DrawOrthoslice,
									   	idPrefix: "ortho",     ui: "DrawOrthosliceCtrl"},
		{type: "draw-polyhedra",       	in: true,  out: false, opt: false, graphic: "out",
										handler: DrawPolyhedra,
									   	idPrefix: "polyhedra", ui: "DrawPolyhedraCtrl"},
		{type: "interpolate-volume",   	in: true,  out: true, opt: false,  graphic: "none",
										handler: InterpolateVolume,
									   	idPrefix: "smooth",    ui: "InterpolateVolumeCtrl"},
		{type: "slice-structure",      	in: true,  out: true, opt: false,  graphic: "out",
										handler: SliceStructure,
									   	idPrefix: "slice",     ui: "SliceStructureCtrl"},
		{type: "measures",             	in: true,  out: false, opt: false, graphic: "out",
										handler: Measures,
									   	idPrefix: "measure",   ui: "MeasuresCtrl"},
		{type: "structure-writer",     	in: true,  out: false, opt: false, graphic: "none",
										handler: StructureWriter,
									   	idPrefix: "writer",    ui: "StructureWriterCtrl"},
		{type: "draw-trajectories",    	in: true,  out: true, opt: true,  graphic: "out",
										handler: Trajectories,
									   	idPrefix: "trace",     ui: "TrajectoriesCtrl"},
		{type: "capture-view",         	in: false, out: false, opt: false, graphic: "none",
										handler: CaptureView,
